...
void semaforStatus1(); // Горит зеленый
void semaforStatus2(); // Моргает зеленый
void semaforStatus3(); // Горит желтый
void semaforStatus4(); // Горит красный и Зеленый пешеходу
void semaforStatus5(); // Горит красный и желтый
void semaforStatusB(); // Горит красный и Зеленый пешеходу долго
...
void loop()
{
    ...
    // Если ввели неверное значение "Настойчиво" напоминаем, что нужно вводить
    else
    {
